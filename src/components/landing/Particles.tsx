...
// Adapted from react-bits' "Particles" background (https://reactbits.dev/backgrounds/particles),
// converted to TypeScript. A lightweight WebGL point-cloud via ogl, used
// for the hero scene's "dance of the cosmos" starfield.
...
/** A drifting field of WebGL points — "dance of the cosmos" for the hero scene. */
